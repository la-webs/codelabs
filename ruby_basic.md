...
グー・チョキ・パーで、じゃんけんゲームをつくりましょう。ルールは、標準的なルールです。
...
以下は、標準入力と標準出力の一例です。この通りでなくても大丈夫です。

```sh
ユーザーが入力: グー
応答: 勝ち（コンピューターは、チョキでした）

ユーザーが入力: チョキ
応答: 負け（コンピューターは、グーでした）
```

## Challenge: あっち向いてホイアプリを作ろう

前のChallengeで作ったじゃんけんアプリを改良して、あっち向いてホイアプリをつくりましょう。
...
2. あっち向いてホイ
    ...
    - **ユーザーからの入力**
      - どの方向を向くのか or 当てるのか（↑↓←→の4方向）

    - **出力**
      - 勝敗
      - どの方向を向いたか or 当てるのか（↑↓←→の4方向）
